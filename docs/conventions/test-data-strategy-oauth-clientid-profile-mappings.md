...
Example using namespace `ob-token-plugin` with profile `STUB`:
```
/{stack-name}/ob-token-plugin/profiles/STUB/client-id
/{stack-name}/ob-token-plugin/profiles/STUB/client-secret
/{stack-name}/ob-token-plugin/profiles/STUB/endpoint-url
/{stack-name}/ob-token-plugin/profiles/STUB/scope
/{stack-name}/ob-token-plugin/profiles/STUB/grant-type
```
