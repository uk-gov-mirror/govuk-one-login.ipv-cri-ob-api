import type { ThirdPartyTokenPluginConfig } from '@src/thirdparty-async-token/plugin-api/token-plugin-config'
...
vi.mock('@src/thirdparty-async-token/lambda/util/plugin-loader', () => ({
  loadPlugin: () =>
    Promise.resolve({
